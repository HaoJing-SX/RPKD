...
class DataAugmentor(object):
    ...
    def random_world_flip(self, data_dict=None, config=None):
        ...
        if config.get('SECOND_DATA', False):
            # print("@@@@@@@@@@@@@@@@@ done_flip:")
            gt_boxes, points, s_points = data_dict['gt_boxes'], data_dict['points'], data_dict['s_points']
            for cur_axis in config['ALONG_AXIS_LIST']:
                assert cur_axis in ['x', 'y']
                gt_boxes, points, s_points, enable = getattr(augmentor_utils, 'random_flip_along_second_%s' % cur_axis)(
                    gt_boxes, points, s_points, return_flip=True
                )
    ...
    def random_world_rotation(self, data_dict=None, config=None):
        ...
        if config.get('SECOND_DATA', False):
            # print("@@@@@@@@@@@@@@@@@ done_rotation:")
            gt_boxes, points, s_points, noise_rot = augmentor_utils.global_rotation_second(
                data_dict['gt_boxes'], data_dict['points'], data_dict['s_points'], rot_range=rot_range, return_rot=True
            )
            data_dict['gt_boxes'] = gt_boxes
            data_dict['points'] = points
            data_dict['s_points'] = s_points
    ...
    def random_world_scaling(self, data_dict=None, config=None):
        ...
        if config.get('SECOND_DATA', False):
            # print("@@@@@@@@@@@@@@@@@ done_scaling:")
            gt_boxes, points, s_points, noise_scale = augmentor_utils.global_scaling_second(
                data_dict['gt_boxes'], data_dict['points'], data_dict['s_points'], config['WORLD_SCALE_RANGE'], return_scale=True
            )
            data_dict['gt_boxes'] = gt_boxes
            data_dict['points'] = points
            data_dict['s_points'] = s_points
