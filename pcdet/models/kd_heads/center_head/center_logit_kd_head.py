...
class CenterLogitKDHead(KDHeadTemplate):
    ...
    def get_kd_loss_with_decoded_boxes(self, pred_tea, loss_cfg):
        """
        Args:
        ...
        """
        # print("@@@@@@@@@@@@ dense_head.forward_ret_dict:", self.dense_head.forward_ret_dict)
        # print("@@@@@@@@@@@@ pred_tea:", pred_tea)
        # a = {}
        # print("stop:", a[10])
        pred_stu = self.dense_head.forward_ret_dict['decoded_pred_dicts']
        batch_kd_hm_loss = 0
        batch_kd_reg_loss = 0
